...
//融资成功
  ...
  function successFun(data){
    if(IFSCommonMethod.isNotBlank(data)){
      ...
      var html=[];
      $("#financeAmount").html(IFSCommonMethod.formatMoney(list.disctAmt));
      ...
      $("#rates").html((list.intRate)+"%");
      $("#discount").html((list.rateDisct)+"%");
      $("#goldDiscount").html(IFSCommonMethod.formatMoney((list.useBouns)+"%"));
